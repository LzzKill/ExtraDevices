...
import com.lzzkill.extradevices.utils;
...
import static com.lzzkill.extradevices.ExtraDevices.EXTRA_DEVICES_TAB;
...
public class CompressedBlockItem extends BlockItem
{
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> list, TooltipFlag tooltipFlag)
    {
        ...
        assert tag != null;
        list.add(new TranslatableComponent("tooltip.compressed_block", String.valueOf(utils.pow(9, this.level))));
    }
